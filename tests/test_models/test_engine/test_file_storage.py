...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Tests that get returns the correct output"""
    ...
    def test_count(self):
        """Tests that count return the correct output"""
        storage = models.storage
